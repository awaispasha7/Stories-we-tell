...
export function SidebarDossier() {
  ...
  return (
    <div className="h-full overflow-y-auto overflow-x-hidden flex flex-col gap-4 sm:gap-6 pt-16 sm:pt-20 pb-8 sm:pb-12 px-4 sm:px-8 lg:px-12" style={{ padding: '2rem' }}>
      {/* Header */}
