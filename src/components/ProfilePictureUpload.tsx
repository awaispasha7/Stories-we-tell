...
export function ProfilePictureUpload({ 
  ...
  return (
    ...
    >
      ...
      <div 
        className={cn(
          "relative rounded-full bg-gradient-to-br from-blue-400 to-purple-500 flex items-center justify-center overflow-hidden transition-all duration-300 cursor-pointer",
          sizeClasses[size],
